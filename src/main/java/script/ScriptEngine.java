...
//	}
	...
	public void load(FileGetter file) throws IOException {
		...
		LinkedList<Script> res = new LinkedList<>();
		Set<String> loaded = new HashSet<>(); // MODDED

		// Create scripts from save
		while(am > 0) {
			am--;
			String nfile = file.chars();
			String nclass = file.chars();
		...
		// MODDED create mods not present in save game. Or else mods can not be added to existing saves.
