...
/**
 * A list with multiple {@link DropDown} buttons.
 */
public class DropDownList extends AbstractButton<List<String>> implements Refreshable {
    ...
    /**
     * Creates a new {@link DropDownList} with multiple dropdowns.
     *
    ...
    private int getAmount() {
        return this.uiList.getElements().size();
    }

    /**
     * Returns a list with the keys of selected buttons in the list.
     *
     * @return a list with the keys of selected buttons
     */
    @Override
    ...
    /**
     * Sets which button shall be selected by a list of keys.
     *
     * @param values to set
     */
    @Override
    ...
    /**
     * Refreshes the amount in the label.
     * Calls the {@link DropDownList#refreshAction}.
     */
    @Override
    public void refresh() {
