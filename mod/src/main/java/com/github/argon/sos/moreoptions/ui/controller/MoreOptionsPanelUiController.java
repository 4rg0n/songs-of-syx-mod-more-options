...
public class MoreOptionsPanelUiController extends AbstractUiUiController<MoreOptionsPanel> {

    private final FullWindow<MoreOptionsPanel> moreOptionsWindow;

    public MoreOptionsPanelUiController(MoreOptionsPanel moreOptionsPanel, FullWindow<MoreOptionsPanel> moreOptionsWindow) {
