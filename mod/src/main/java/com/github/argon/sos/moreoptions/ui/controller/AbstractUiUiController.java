...
public abstract class AbstractUiUiController<Element> extends com.github.argon.sos.mod.sdk.ui.controller.AbstractUiController<Element> {
    protected static final I18nTranslator i18n = ModModule.i18n().get(AbstractUiUiController.class);
    private final static Logger log = Loggers.getLogger(AbstractUiUiController.class);
    ...
    public AbstractUiUiController(Element element) {
        super(element);
    }
