...
public class ErrorDialogUiController extends AbstractUiUiController<ErrorDialog> {
    private final Window<ErrorDialog> errorDialog;
    private final String reportUrl;

    public ErrorDialogUiController(Window<ErrorDialog> errorDialog, String reportUrl) {
