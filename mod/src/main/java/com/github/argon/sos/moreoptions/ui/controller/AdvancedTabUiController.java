...
public class AdvancedTabUiController extends AbstractUiUiController<AdvancedTab> {

    private final MoreOptionsPanel moreOptionsPanel;

    public AdvancedTabUiController(AdvancedTab advancedTab, MoreOptionsPanel moreOptionsPanel) {
        super(advancedTab);
