package com.github.argon.sos.moreoptions.testing;
...
public class ModExtension implements TestInstancePostProcessor {

    private final static Logger log = Loggers.getLogger(ModExtension.class);
